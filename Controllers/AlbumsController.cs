...
namespace Secheli_Stefania_Proiect.Controllers
{
    public class AlbumsController : Controller
    {
                ...
                int? pageNumber)
        {
            ...
            var albums = from b in _context.Albums
                         select b;
            ...
            {
                case "name_desc":
                    albums = albums.OrderByDescending(b => b.Name);
                    break;
                case "Price":
                ...
                case "price_desc":
                    ...
                    break;
                default:
                    albums = albums.OrderBy(b => b.Name);
                    break;
            }
            int pageSize = 2;
        ...
        public async Task<IActionResult> Create([Bind("Name,Artist,Price")] Album album)
        {
            try
            {
